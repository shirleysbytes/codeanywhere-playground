...
describe('Scrape', () => {
    ...
    const targets = [
        {store: "Target", url: "https://www.target.com/p/playstation-5-console/-/A-81114595#lnk=sametab", element: ""}, 
        {store: "Newegg", url: "https://www.newegg.com/p/N82E16868110300", element: ""},
    ...
    targets.forEach((target) => {
        it(`Should load ${target.store}`, async () => {
            ...
            await expect($(target.element).getText).toContain("Add to Cart")
        })
    })
});
